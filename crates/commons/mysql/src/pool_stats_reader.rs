//! `PoolStatsReader` wrapper for the sqlx MySQL pool. Cheap by-value
...
pub struct MySqlPoolStatsReader {
    pool: MySqlPool,
}

impl MySqlPoolStatsReader {
    pub fn new(pool: MySqlPool) -> Self {
        Self { pool }
    }
}

impl PoolStatsReader for MySqlPoolStatsReader {
